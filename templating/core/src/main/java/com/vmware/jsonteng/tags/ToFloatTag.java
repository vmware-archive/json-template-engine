...
public class ToFloatTag extends TagBase {
    static final String name = "to-float";

    private final ElementResolver elementResolver;

    public ToFloatTag(TagResolver tagResolver) {
        super(tagResolver);
    ...
    public Object process(List<?> tagTokens, List<Map<String, ?>> bindingDataList) throws TemplateEngineException {
        ...
        if (resolvedData instanceof String) {
            try {
                return Double.parseDouble((String) resolvedData);
