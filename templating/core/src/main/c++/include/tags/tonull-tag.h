...
namespace jsonteng {
static const std::string ToNullTag_name("to-null");

class ToNullTag : public TagBase {
public:
  ToNullTag(const TagResolverIf &tag_resolver)
      : TagBase(tag_resolver, ToNullTag_name) {}
  virtual ~ToNullTag() {}
